    ...
    <div class="bg-white">
        ...
        <div class="mt-2 w-full">
            <div class="md:px-[15rem] flex gap-5 items-center px-4  text-sm md:text-lg">
                ...
                <div> > </div>
                <a href="{{route('notifications')}}" class="hover:underline text-orange-500">Wishlists</a>
            </div>
        </div>
        @php
        $wishlists = [
        ['title' => 'Pedigree 18 Pouch Variety Pack', 'price' => '350.00', 'description' => 'Lorem ipsum dolor sit amet consectetur, adipisicing elit.'],
        ['title' => 'Pedigree 18 Pouch Variety Pack', 'price' => '350.00', 'description' => 'Lorem ipsum dolor sit amet consectetur, adipisicing elit.'],
        ['title' => 'Pedigree 18 Pouch Variety Pack', 'price' => '350.00', 'description' => 'Lorem ipsum dolor sit amet consectetur, adipisicing elit.'],
        ];
        @endphp
        ...
        <div class="flex flex-col items-center justify-center w-full px-4">
            ...
            <div class="flex flex-col lg:flex-row items-center lg:items-start gap-6 p-6 md:px-12 mt-6 border pb-6 w-full max-w-5xl mx-auto rounded-lg shadow-md bg-white">
                ...
                <div class="flex-1 text-center lg:text-left">
                    <h1 class="font-bold text-xl lg:text-2xl text-gray-800">{{ $wishlist['title'] }}</h1>
                    <h3 class="mt-2 text-gray-500 text-sm lg:text-base">₱{{ $wishlist['price'] }}</h3>
                    <p class="mt-2 text-gray-700 text-sm lg:text-base">{{ $wishlist['description'] }}</p>
