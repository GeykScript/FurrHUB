            ...
            <div class="p-4 ">
                ...
                <nav class="font-bold">
                    <ul>
                        ...
                        <li class="mb-2 border border-gray shadow-sm rounded-lg">
                            <a href="orders" class="block p-3 flex text-lg items-center text-white bg-[#F0A02C] rounded transition duration-200">
                ...
                <div class="flex justify-between mb-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select class="border rounded-md px-3 py-2 bg-white">
                            <option>All</option>
                            <option value="">To Ship</option>
                            <option value="">To Pay</option>
                            <option value="">Delivered</option>
                        </select>

                        <span class="pl-5 ml-5 text-m text-gray-600">Generate Report:</span>
                ...
                <div class="overflow-x-auto ">
                    <div class="border border-black rounded-lg">
                        <table class="min-w-full border-collapse">
                            <thead>
                                <tr>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Order ID</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Customer Name</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Product Name</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Quantity</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Total Amount</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Payment Method</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Ref. Number</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Payment Status</th>
                                    <th class="px-4 py-3 text-left text-sm font-bold text-black">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="px-4 py-3">Pedigree</td>
                                    <td class="px-4 py-3">1</td>
                                    <td class="px-4 py-3">₱150</td>
                                    <td class="px-4 py-3">GCash</td>
                                    <td class="px-4 py-3">2553-2424-456</td>
                                    <td class="px-4 py-3">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-500">Confirmed</span>
                                    </td>
                                    <td class="px-4 py-3">To Ship</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="px-4 py-3">GCash</td>
                                    <td class="px-4 py-3">1234-5678-901</td>
                                    <td class="px-4 py-3">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-500">Confirmed</span>
                                    </td>
                                    <td class="px-4 py-3">To Ship</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3">0987-6543-210</td>
                                    <td class="px-4 py-3">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Pending</span>
                                    </td>
                                    <td class="px-4 py-3">To Pay</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
