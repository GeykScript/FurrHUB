        ...
        <main class="flex-1 ml-72 w-full bg-gray-100">
            ...
            <div class="mt-2 w-full">
                <div class="md:px-[5rem] flex gap-5 items-center px-4  text-sm md:text-lg">
                    ...
                    <div> > </div>
                    <a href="{{route('admin_products.page')}}" class="hover:underline text-orange-500">Add Product</a>
                </div>
            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="grid grid-cols-2 gap-2 mt-2">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" id="product_price" name="product_price" value="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                    </div>
                                    <div class="mb-4">
